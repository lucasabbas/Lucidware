...
public static class StringMacros
{
    ...
    public static string ParseMacros(this string s, IoCore assetIo = null)
    {
        ...
        if (s.Contains("$ASSET(") && assetIo != null)
        {
            ...
            s = s.Replace("$ASSET(" + asset + ")", assetIo.LoadString(asset));
        }

        return s;
    }

    public static int ParseMacrosToInt(this string str, IoCore assetIo = null)
    {
        return int.Parse(str.ParseMacros(assetIo));
    }

    public static float ParseMacrosToFloat(this string str, IoCore assetIo = null)
    {
        return float.Parse(str.ParseMacros(assetIo));
    }

    public static long ParseMacrosToLong(this string str, IoCore assetIo = null)
    {
        return long.Parse(str.ParseMacros(assetIo));
    }

    public static double ParseMacrosToDouble(this string str, IoCore assetIo = null)
    {
